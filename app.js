...
document.getElementById('Arrow-up-phone').addEventListener('click', startGameWithButton);
document.getElementById('Arrow-down-phone').addEventListener('click', startGameWithButton);
document.getElementById('Arrow-left-phone').addEventListener('click', startGameWithButton);
document.getElementById('Arrow-right-phone').addEventListener('click', startGameWithButton);
